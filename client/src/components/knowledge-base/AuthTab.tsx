...
import { Loader2, CheckCircle2, RefreshCw, Trash2 } from "lucide-react"
...
}: { shopDomain: string; storefrontAccessToken: string }) {
...
export default function AuthTab() {
  ...
  React.useEffect(() => {
    if (
      isShopifyDialogOpen ||
      isWordPressDialogOpen ||
      isBigCommerceDialogOpen ||
      isSquarespaceDialogOpen ||
      isWixDialogOpen ||
      isWebflowDialogOpen
    ) {
  ...
  async function connectWordPress({
    ...
    consumerKey,
    consumerSecret,
  }: { siteUrl: string; consumerKey: string; consumerSecret: string }) {
  ...
  return (
    <div className="space-y-8 p-6 lg:p-8">
      <div className="border-b border-border pb-6">
        <h2 className="text-2xl font-bold text-foreground mb-2">API Integrations</h2>
      ...
      {(isShopifyConnected ||
        ...
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-1">Active Connections</h3>
            <p className="text-sm text-muted-foreground">Manage your connected services</p>
          </div>

          <div className="space-y-3">
            {isShopifyConnected && (
              <Card className="border border-green-200 bg-green-50/50 dark:bg-green-950/20 dark:border-green-900/50">
                <CardContent className="pt-6">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-green-100/50 dark:bg-green-900/30 rounded-lg">
                      <div className="flex items-center gap-3">
                        <CheckCircle2 className="w-5 h-5 text-green-600" />
                        <div>
                          <p className="font-medium text-foreground">Connected to Shopify</p>
                          <p className="text-sm text-muted-foreground">Shop: {shopifyCredentials.shopDomain}</p>
                        </div>
                      </div>
                      <Button
                    ...
                    <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Site: {wordpressCredentials.siteUrl}</p>
                        </div>
                      </div>
                      <Button
                    ...
                    <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Store: {bigcommerceCredentials.storeHash}</p>
                        </div>
                      </div>
                      <Button
                    ...
                    <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Site: {squarespaceCredentials.siteUrl}</p>
                        </div>
                      </div>
                      <Button
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-lg font-semibold text-foreground mb-1">Available Integrations</h3>
          <p className="text-sm text-muted-foreground">Add new integrations to expand your capabilities</p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3 auto-rows-max">
            ...
            <CardContent className="pt-6 pb-6">
              <div className="flex flex-col items-center justify-center space-y-4">
                ...
                <div className="text-center">
                  <h4 className="font-semibold text-foreground">Shopify</h4>
          ...
          <Card
            className="cursor-pointer hover:shadow-md hover:border-primary/30 transition-all duration-200 overflow-hidden group"
            onClick={() => setIsBigCommerceDialogOpen(true)}
          >
            <CardContent className="pt-6 pb-6">
              <div className="flex flex-col items-center justify-center space-y-4">
                <div className="flex justify-center h-16 w-full items-center">
                ...
                <div className="text-center">
                  <h4 className="font-semibold text-foreground">BigCommerce</h4>
                  <p className="text-xs text-muted-foreground mt-1">
          ...
          <Card
            className="cursor-pointer hover:shadow-md hover:border-primary/30 transition-all duration-200 overflow-hidden group"
            onClick={() => setIsSquarespaceDialogOpen(true)}
          >
            <CardContent className="pt-6 pb-6">
              <div className="flex flex-col items-center justify-center space-y-4">
                <div className="flex justify-center h-16 w-full items-center">
                ...
                <div className="text-center">
                  <h4 className="font-semibold text-foreground">Squarespace</h4>
                  <p className="text-xs text-muted-foreground mt-1">
          ...
          <Card
            className="cursor-pointer hover:shadow-md hover:border-primary/30 transition-all duration-200 overflow-hidden group"
            onClick={() => setIsWixDialogOpen(true)}
          >
            <CardContent className="pt-6 pb-6">
              <div className="flex flex-col items-center justify-center space-y-4">
                <div className="flex justify-center h-16 w-full items-center">
                ...
                <div className="text-center">
                  <h4 className="font-semibold text-foreground">Wix</h4>
                  <p className="text-xs text-muted-foreground mt-1">
          ...
          <Card
            className="cursor-pointer hover:shadow-md hover:border-primary/30 transition-all duration-200 overflow-hidden group"
            onClick={() => setIsWebflowDialogOpen(true)}
          >
            <CardContent className="pt-6 pb-6">
              <div className="flex flex-col items-center justify-center space-y-4">
                <div className="flex justify-center h-16 w-full items-center">
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Get this from Shopify Admin → Settings → Apps and sales channels → Develop apps → Your app → API
          ...
          <div className="space-y-4 mt-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                data-lpignore="true"
              />
              <p className="text-xs text-muted-foreground">Enter your WordPress site URL (e.g., https://example.com)</p>
            </div>
      ...
      <Dialog open={isBigCommerceDialogOpen} onOpenChange={setIsBigCommerceDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>Enter your BigCommerce store hash and API access token.</DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 mt-4">
            ...
            <Button
              ...
              disabled={
                connectBigCommerceMutation.isPending || !bigcommerceStoreHash.trim() || !bigcommerceAccessToken.trim()
              }
              className="w-full"
              size="lg"
            >
      ...
      <Dialog open={isSquarespaceDialogOpen} onOpenChange={setIsSquarespaceDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>Enter your Squarespace site URL and API key.</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isWixDialogOpen} onOpenChange={setIsWixDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>Enter your Wix site ID and OAuth access token.</DialogDescription>
          </DialogHeader>
              ...
              <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Site ID: {wixCredentials?.siteId}</p>
                  </div>
                </div>
                <Button
      ...
      <Dialog open={isWebflowDialogOpen} onOpenChange={setIsWebflowDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>Enter your Webflow site ID and API access token.</DialogDescription>
          </DialogHeader>
              ...
              <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Site ID: {webflowCredentials?.siteId}</p>
                  </div>
                </div>
                <Button
